...
$financials_query = "
    SELECT 
        ...
        COALESCE(SUM(p.selling_price * oi.quantity), 0) AS total_selling_price
    FROM order_items oi
...
$total_selling_price = $financials_row['total_selling_price'] ?? 0.00;
...
<body class="flex h-screen bg-gray-100">
    ...
    <div class="w-64 bg-gray-800 text-white">
        ...
        <ul class="mt-6 space-y-2">
            ...
            <li><a href="seller-sales-summary.php" class="block px-4 py-2 hover:bg-gray-700">Sales Summary</a></li>
            <li>
                <!-- Logout Form -->
                <form method="post">
    ...
    <div class="flex-1 p-8">
        <section id="user-info" class="bg-white shadow-md p-6 rounded-lg mb-8">
            ...
            <p class="text-gray-600">Total Selling Price: <strong class="text-purple-500">$<?php echo number_format($total_selling_price, 2); ?></strong></p>
